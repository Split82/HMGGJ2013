...
const float START_ENEMIES_PER_WAVE[]      = {    1.000f,    1.000f,   10.000f,   15.000f};
const float END_ENEMIES_PER_WAVE[]        = {   10.000f,   10.000f,   15.000f,   20.000f};

const float START_SWIPE_ENEMIES_RATIO[]   = {    0.000f,    0.120f,    0.200f,    0.400f};
const float END_SWIPE_ENEMIES_RATIO[]     = {    0.000f,    0.200f,    0.500f,    0.500f};

const float START_WAVE_LENGTH[]           = {   10.000f,   15.000f,   15.000f,   15.000f};
const float END_WAVE_LENGTH[]             = {   10.000f,   12.000f,   10.000f,    5.000f};

const float ENEMIES_DELTA[]               = {    1.000f,    1.000f,    1.000f,    1.000f};
const float SWIPE_ENEMIES_DELTA[]         = { CALCULATE, CALCULATE, CALCULATE, CALCULATE};
const float WAVE_LENGHT_DELTA[]           = { CALCULATE,    0.000f,    0.000f,   -0.750f};

const float ENEMY_IDLE_SPAWN_TIME[]       = {    7.000f,    7.000f,    7.000f,    7.000f};
const float ENEMY_IDLE_SPAWN_DELTA_TIME[] = {    10.000f,    3.000f,    3.000f,    3.000f};
