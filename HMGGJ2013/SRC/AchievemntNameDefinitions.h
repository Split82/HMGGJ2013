...
NSString * const kAchievemntKill10000Name; // kill 10.000 imps $
NSString * const kAchievemntKill100000Name; // kill 100.000 imps $
NSString * const kAchievemntKill1000000Name; // kill 1.000.000 imps $
NSString * const kAchievemntOneInATousandName; // you are the chosen one $
NSString * const kAchievemntDrop100Name; // MQ-1 Predator - drop 100 bombs $
NSString * const kAchievemntDrop1000Name; // F/A-18 Hornet - drop 1.000 bombs $
NSString * const kAchievemntDrop10000Name; // Tu-95 - drop 10.000 bombs $
